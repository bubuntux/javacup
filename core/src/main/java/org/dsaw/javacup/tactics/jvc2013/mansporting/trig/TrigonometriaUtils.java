...
public final class TrigonometriaUtils {
    ...
    public static double getModuloVector(Punto3D punto) {
        return Math.sqrt(Math.pow(punto.getX(), 2) + Math.pow(punto.getY(), 2) + Math.pow(punto.getZ(), 2));
    }
    ...
    public static double getDistancia(Punto3D puntoA, Punto3D puntoB) {
        return Math.sqrt(Math.pow(puntoB.getX() - puntoA.getX(), 2) + Math.pow(puntoB.getY() - puntoA.getY(), 2) + Math.pow(puntoB.getZ() - puntoA.getZ(), 2));
    }
    ...
    public static boolean isContenido(Punto p, Rectangulo r) {
        if (p.getX() < r.getCentro().getX() - r.getAncho() / 2 || p.getX() > r.getCentro().getX() + r.getAncho() / 2) {
            return false;
        }
        if (p.getY() < r.getCentro().getY() - r.getAlto() / 2 || p.getY() > r.getCentro().getY() + r.getAlto() / 2) {
            return false;
        }
        return true;
    }
    ...
    public static Punto[] getInterseccion(Segmento a, Rectangulo b) {
        Punto punto1 = new Punto(b.getCentro().getX() - b.getAncho() / 2, b.getCentro().getY() + b.getAlto() / 2);
        Punto punto2 = new Punto(b.getCentro().getX() + b.getAncho() / 2, b.getCentro().getY() + b.getAlto() / 2);
        Punto punto3 = new Punto(b.getCentro().getX() + b.getAncho() / 2, b.getCentro().getY() - b.getAlto() / 2);
        Punto punto4 = new Punto(b.getCentro().getX() - b.getAncho() / 2, b.getCentro().getY() - b.getAlto() / 2);
    ...
    public static Punto[] getInterseccion(Recta a, Circulo b) {
        double[] xValues = getSolutionEcuationReal(
                ...
                Math.pow(b.getCentro().getX(), 2) + Math.pow(a.getB(), 2) - 2 * b.getCentro().getY() * a.getB() + Math.pow(b.getCentro().getY(), 2) - Math.pow(b.getRadio(), 2));
    ...
    public static Punto[] getInterseccion(Circulo a, Circulo b) {
        ...
        double f = Math.pow(a.getCentro().getX(), 2) + Math.pow(a.getCentro().getY(), 2) - Math.pow(a.getRadio(), 2);

        double g = - 2 * b.getCentro().getX();
        double h = - 2 * b.getCentro().getY();
        double i = Math.pow(b.getCentro().getX(), 2) + Math.pow(b.getCentro().getY(), 2) - Math.pow(b.getRadio(), 2);
