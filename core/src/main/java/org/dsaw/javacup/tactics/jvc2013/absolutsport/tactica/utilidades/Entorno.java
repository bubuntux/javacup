...
public class Entorno {
  ...
  public static final double DISTANCIA_MARCAJE_DEFENSA = 0.3;
  ...
  public static final double
      DISTANCIA_MAX_GOLPEO_ALTO =
      Constants.LARGO_CAMPO_JUEGO - Constants.ANCHO_AREA_CHICA;
  ...
  public static Zona zona[] = new Zona[]{
      new Zona(-LADO_ZONA_PORTERO, LADO_ZONA_PORTERO,
               Constants.centroArcoInf.getY() + LADO_ZONA_PORTERO, Constants.centroArcoInf.getY()),

      new Zona((Constants.ANCHO_CAMPO_JUEGO / 4) + 0.00001, Constants.ANCHO_CAMPO_JUEGO / 2,
               Entorno.LIMITE_DEFENSA, -Constants.LARGO_CAMPO_JUEGO / 2),
      new Zona(-Constants.ANCHO_CAMPO_JUEGO / 2, -Constants.ANCHO_CAMPO_JUEGO / 4,
               Entorno.LIMITE_DEFENSA, -Constants.LARGO_CAMPO_JUEGO / 2),
      new Zona(0.00001, Constants.ANCHO_CAMPO_JUEGO / 4, Entorno.LIMITE_DEFENSA,
               -Constants.LARGO_CAMPO_JUEGO / 2),
      new Zona((-Constants.ANCHO_CAMPO_JUEGO / 4) + 0.00001, 0, Entorno.LIMITE_DEFENSA,
               -Constants.LARGO_CAMPO_JUEGO / 2),

      new Zona(0.00001, Constants.ANCHO_CAMPO_JUEGO / 4, Entorno.LIMITE_MEDIO,
               Entorno.LIMITE_DEFENSA),
      new Zona((Constants.ANCHO_CAMPO_JUEGO / 4) + 0.00001, Constants.ANCHO_CAMPO_JUEGO / 2,
               Entorno.LIMITE_MEDIO, Entorno.LIMITE_DEFENSA),
      new Zona((-Constants.ANCHO_CAMPO_JUEGO / 4) + 0.00001, 0, Entorno.LIMITE_MEDIO,
               Entorno.LIMITE_DEFENSA),
      new Zona(-Constants.ANCHO_CAMPO_JUEGO / 2, 0, Constants.LARGO_CAMPO_JUEGO / 2,
               Entorno.LIMITE_MEDIO),

      new Zona(0, Constants.ANCHO_CAMPO_JUEGO / 2, Constants.LARGO_CAMPO_JUEGO / 2,
               Entorno.LIMITE_MEDIO),
      new Zona(-Constants.ANCHO_CAMPO_JUEGO / 2, -Constants.ANCHO_CAMPO_JUEGO / 4,
               Entorno.LIMITE_MEDIO, Entorno.LIMITE_DEFENSA),
  };
