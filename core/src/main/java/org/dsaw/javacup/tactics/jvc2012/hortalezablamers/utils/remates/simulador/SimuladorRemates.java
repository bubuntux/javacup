package org.dsaw.javacup.tactics.jvc2012.hortalezablamers.utils.remates.simulador;
    ...
    while (true) {
      ...
      if (alturaBalon <= Constants.ALTO_ARCO) {
        ...
        for (int i : indicesPendientesIntercepcion) {
          if (alturaBalon <= (Common.dentroAreaRival(posicionBalon) ? Constants.ALTO_ARCO
            ...
            double
                dist =
                pJug.distance(posicionBalon) - (Common.dentroAreaRival(posicionBalon)
