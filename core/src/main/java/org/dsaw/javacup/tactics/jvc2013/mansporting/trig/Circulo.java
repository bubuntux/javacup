...
/**
 * <br> Figura que representa un círculo (x - a)^2 + (y - b)^2 = r^2. <br> <br>Copyright Fi2net S.A.
 * 10-ene-2011
 */
public class Circulo {
  ...
  public boolean isPoint(Punto punto) {
    ...
    for (double y : getY(punto.getX())) {
      if (TrigonometriaUtils.getDistancia(punto, new Punto(punto.getX(), y))
          <= MSGConstants.PRECISION_COMPARAR_DISTANCIAS) {
        return true;
      }
    }
    return false;
