package org.dsaw.javacup.tactics.jvc2013.arturo8a;
...
public class TacticaPulgarcitos implements Tactic {
  ...
  public MyPosition[] predictBall(MyPosition ball, double iBallDx, double iBallDy, double iBallDz,
                                  int previsions, GameSituations sp) {
  ...
  public List<Command> execute(GameSituations sp) {
...

    {
      MyPosition[]
          evolution =
          predictBall(ballwithZ, currentDx, currentDy, currentDz, MAX_PREVISION, sp);
      DecisionScore ds = new DecisionScore(evolution);
