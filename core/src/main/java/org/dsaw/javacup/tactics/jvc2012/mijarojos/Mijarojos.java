...
public class Mijarojos implements Tactic {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Jugador", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          0.5d, true),
          new JugadorImpl("Jugador", 2, new Color(255, 200, 150), new Color(50, 0, 0), 0.76d, 1.0d,
                          0.63d, false),
          new JugadorImpl("Jugador", 3, new Color(255, 200, 150), new Color(50, 0, 0), 0.76d, 1.0d,
                          0.65d, false),
          new JugadorImpl("Jugador", 4, new Color(255, 200, 150), new Color(50, 0, 0), 0.76d, 1.0d,
                          0.65d, false),
          new JugadorImpl("Jugador", 5, new Color(255, 200, 150), new Color(50, 0, 0), 0.76d, 1.0d,
                          0.65d, false),
          new JugadorImpl("Jugador", 6, new Color(255, 200, 150), new Color(50, 0, 0), 0.92d, 0.76d,
                          0.74d, false),
          new JugadorImpl("Jugador", 7, new Color(255, 200, 150), new Color(50, 0, 0), 0.92d, 0.76d,
                          0.74d, false),
          new JugadorImpl("Jugador", 8, new Color(255, 200, 150), new Color(50, 0, 0), 0.92d, 0.76d,
                          0.74d, false),
          new JugadorImpl("Jugador", 9, new Color(255, 200, 150), new Color(50, 0, 0), 0.97d, 0.75d,
                          0.95d, false),
          new JugadorImpl("Jugador", 10, new Color(255, 200, 150), new Color(50, 0, 0), 0.98d,
                          0.84d, 0.95d, false),
          new JugadorImpl("Jugador", 11, new Color(255, 200, 150), new Color(50, 0, 0), 0.97d,
                          0.75d, 0.95d, false)
      };
    }
  }
  ...
  public List<Command> execute(GameSituations sp) {
    ...
    List<CommandMoveTo> lstTmpMoveTo;
    List<CommandHitBall> lstTmpHitBall;
