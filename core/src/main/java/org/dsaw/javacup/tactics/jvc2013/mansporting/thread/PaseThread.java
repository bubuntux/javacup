...
public class PaseThread implements IdentificableCallable<MSGJugadorPropio, PaseData> {
  ...
  public PaseThread(MSGJugadorPropio jugadorPasador, Punto3D balonEnPase,
                    MSGJugadorPropio jugadorDestino, Punto3D puntoDestino,
                    MSGSituacionPartidoContext context) {
