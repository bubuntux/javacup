...
public class RemateAPuerta {
  ...
  /**
   * Calcula el angulo horizontal de remate en funcion de la posicion del balon y la posicion del
   * portero rival
   */
  public static CommandHitBall rematarAPuerta(GameSituations gs, int indicePorteroRival,
                                              int indiceRematador) {
    ...
    return new CommandHitBall(indiceRematador, Math.toDegrees(direccionRemate),
                              HBConstants.FUERZA_GOLPEO_MAXIMA, HBConstants.ANGULO_GOLPEO_TIRO);
  }
}
