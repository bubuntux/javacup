...
public class JugadorImpl implements PlayerDetail {
  ...
  public JugadorImpl(String nombre, int numero, Color piel, Color pelo,
                     ...
                     boolean rematador, boolean controlador, Position proyeccionPase,
   ...
   *
   * @return <code>true</code> si este jugador se caracteriza por controlar el balón,
   ...
   *
   * @return <code>true</code> si este jugador se caracteriza por transportar el balón,
   * <code>false</code> de lo contrario.
   */
  ...
  /**
   * Retorna las posiciones de la cancha a las que este jugador tiene como referencias para driblar.
   * Los primeros elementos son de mayor preferencia que los ultimos.
   *
   * @return Un arreglo con las posiciones de la cancha a las que este jugador tiene como
   * referencias para driblar.
   */
  ...
  /**
   * Retorna los indices de los jugadores a los que este jugador tiene como referencias para pasar
   * el balón en cada uno de los cuartos de la cancha. Para cada cuarto, los primeros elementos son
   * de mayor preferencia que los ultimos.
   *
   * @return Un arreglo con los indices de los jugadores a los que este jugador tiene como
  ...
  /**
   * Retorna los indices de los jugadores a los que este jugador tiene como referencias para pasar
   * el balón en un determinado cuarto de la cancha. Los primeros elementos son de mayor preferencia
   * que los ultimos.
   *
   * @param cuartoCancha El cuarto de la cancha en el que se encuentra el balón.
   * @return Un arreglo con los indices de los jugadores a los que este jugador tiene como
   * referencias para pasar el balón en un cuarto determinado de la cancha.
   */
   ...
   *
   * @return <code>true</code> si este jugador se caracteriza por disparar a la porteria,
   * <code>false</code> de lo contrario.
   */
