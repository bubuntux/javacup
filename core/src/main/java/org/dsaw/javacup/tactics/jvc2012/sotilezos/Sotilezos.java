package org.dsaw.javacup.tactics.jvc2012.sotilezos;
  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Kasiyas", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, true),
          new JugadorImpl("Halbaro Harveloa", 2, new Color(255, 200, 150), new Color(50, 0, 0),
                          1.0d, 1.0d, 1.0d, false),
          new JugadorImpl("Halviol", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.0d,
                          0.0d, false),
          new JugadorImpl("Zerjio Ramos", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                          0.0d, 0.0d, false),
          new JugadorImpl("Marrzelo", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Las Diara", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                          0.42d, 0.08d, false),
          new JugadorImpl("Savi Halonso", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Kristiano Ronaldo", 8, new Color(255, 200, 150), new Color(50, 0, 0),
                          1.0d, 1.0d, 1.0d, false),
          new JugadorImpl("Bencena", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Hozil", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Kayegon", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false)
      };
    }
  }
