...
public class Tactica implements Tactic {
  ...
  class TacticDetailImpl implements Team {
    ...
    public Player[] getPlayers() {
      return new Player[]{
          ...
          new JugadorImpl("Sparrowhawk", 2, new Color(255, 200, 150), new Color(153, 102, 0), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Rom�n", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Sergio", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Lolo", 5, new Color(255, 200, 150), new Color(50, 0, 0), 0.54d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Harry", 6, new Color(255, 200, 150), new Color(50, 0, 0), 0.51d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Fran", 7, new Color(255, 200, 150), new Color(50, 0, 0), 0.78d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Chico", 8, new Color(255, 200, 150), new Color(50, 0, 0), 0.74d, 0.8d,
                          0.5d, false),
          new JugadorImpl("Rafa", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.81d,
                          0.5d, false),
          new JugadorImpl("Oscar", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.8d,
                          0.5d, false),
          new JugadorImpl("Jugador", 11, new Color(255, 200, 150), new Color(255, 200, 150), 1.0d,
                          0.52d, 0.5d, false)
      };
    }
  }

  Team detalle = new TacticDetailImpl();
