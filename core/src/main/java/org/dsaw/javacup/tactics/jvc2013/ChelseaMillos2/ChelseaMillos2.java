...
package org.dsaw.javacup.tactics.jvc2013.ChelseaMillos2;
    ...
    public Player[] getPlayers() {
      return new Player[]{
          ...
          new JugadorImpl("ferreira", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("therry", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("ivanovich", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("ashly cole", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1d,
                          0.625d, 0.5d, false),
          new JugadorImpl("michel", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("malouda", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("alex", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("lampard", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false),
          new JugadorImpl("anelka", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false),
          new JugadorImpl("drogba", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false)
      };
    }
  }
...
//                }
...

    {
      MyPosition[]
          evolution =
          predictBall(ballwithZ, currentDx, currentDy, currentDz, MAX_PREVISION);
      DecisionScore ds = new DecisionScore(evolution);
