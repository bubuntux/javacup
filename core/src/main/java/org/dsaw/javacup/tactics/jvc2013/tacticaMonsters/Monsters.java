...
public class Monsters implements Tactic {
  ...
  class TacticaDetalleImpl implements Team {
    ...
    public PlayerI[] getPlayers() {
      return new PlayerI[]{
          ...
          new JugadorImpl("Hubert Farnsworth", 3, new Color(255, 204, 204),
                          new Color(255, 255, 255), 1.0d, 1.0d, 0.5d, false),
          new JugadorImpl("Roberto", 4, new Color(255, 102, 51), new Color(255, 255, 255), 1.0d,
                          1.0d, 0.5d, false),
          new JugadorImpl("Zoidberg", 5, new Color(255, 102, 102), new Color(255, 255, 255), 1.0d,
                          0.5d, 0.5d, false),
          new JugadorImpl("Trokero", 6, new Color(255, 204, 204), new Color(255, 255, 255), 1.0d,
                          0.5d, 0.5d, false),
          new JugadorImpl("Txori", 7, new Color(255, 0, 0), new Color(255, 255, 255), 1.0d, 0.5d,
                          0.5d, false),
          new JugadorImpl("Jonan", 8, new Color(255, 0, 0), new Color(255, 255, 255), 1.0d, 0.5d,
                          0.5d, false),
          new JugadorImpl("Josepo", 9, new Color(255, 0, 0), new Color(255, 255, 255), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Harringui", 10, new Color(255, 0, 0), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Jonhy Temeto", 11, new Color(255, 0, 0), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false)
      };
    }
  }
      ...
      for (int i : sp.canKick()) {
        if (i < 3) {//despejar
          ...
          double tiro[] = sim.calcularTiroCercano(spAct.ballAltitude(),
                                                  ...
                                                  spAct.myPlayersDetail()[i].getPower() * 1.2
                                                  + 1.2);
          ...
          if (!tiroLejano) {
            ...
            if (jug != -1) {
              ...
              double[]
                  pase =
                  sim.calcularPaseAire((1.2 + 1.2 * spAct.myPlayersDetail()[i].getPower()) * factor,
                                       spAct.myPlayers()[jug].distance(sp.ballPosition()),
                                       sp.ballAltitude());
              if (pase[0] != -1) {
                pase2 = true;
  ...
  public int jugAdelantadoPosible(int j) {
    ...
    double[] distMaxPosible = sim.distanciaHastaControlBalon2(spAct.ballAltitude(),
                                                              spAct.myPlayersDetail()[j].getPower()
                                                              * 1.2 + 1.2, 45, false);
