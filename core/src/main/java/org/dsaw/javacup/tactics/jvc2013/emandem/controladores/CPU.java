...
public class CPU {
  ...
  public List<Command> getComandosEjecutar(GameSituations situacionPartido) {
    ...
    Position[]
        alineacionActual =
        ControladorAlineaciones.getInstance().getAlineacionActual(situacionPartido);

    this.comandos
        .addAll(ControladorPortero.getInstance().getComandos(situacionPartido, alineacionActual));

    this.comandos
        .addAll(ControladorJugadores.getInstance().getComandos(situacionPartido, alineacionActual));
