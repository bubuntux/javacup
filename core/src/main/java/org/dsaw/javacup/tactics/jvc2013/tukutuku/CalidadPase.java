...
public class CalidadPase {
  ...
  public boolean esMejor(PaseInfo pInf) {
    ...
    if ((this.posFinalBalon != null) && (pInf.calidad.posFinalBalon != null)) {
      if ((this.posFinalBalon).isInsideGameField(0) != (pInf.calidad.posFinalBalon
                                                            .isInsideGameField(0))) {
    ...
    if (Constants.centroArcoSup.distance(this.posFinalBalon) != Constants.centroArcoSup
        .distance(pInf.calidad.posFinalBalon)) {
      return (Constants.centroArcoSup.distance(this.posFinalBalon) < Constants.centroArcoSup
          .distance(pInf.calidad.posFinalBalon));
    }
