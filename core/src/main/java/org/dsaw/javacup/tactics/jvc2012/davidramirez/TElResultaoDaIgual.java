package org.dsaw.javacup.tactics.jvc2012.davidramirez;
...
public class TElResultaoDaIgual implements Tactic {
  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Macias P", 1, new Color(179, 134, 71), new Color(19, 0, 0), 1.0d, 1.0d,
                          1.0d, true),
          new JugadorImpl("Paquico Navaja", 2, new Color(179, 134, 71), new Color(50, 0, 0), 1.0d,
                          0.76d, 0.0d, false),
          new JugadorImpl("Johny Er Lokoh", 3, new Color(179, 134, 71), new Color(50, 0, 0), 1.0d,
                          0.76d, 0.0d, false),
          new JugadorImpl("Lau ReShul", 4, new Color(179, 134, 71), new Color(50, 0, 0), 1.0d,
                          0.66d, 0.0d, false),
          new JugadorImpl("Toni Cuchara", 5, new Color(179, 134, 71), new Color(50, 0, 0), 1.0d,
                          0.66d, 0.0d, false),
          new JugadorImpl("Peper Manosuelta", 6, new Color(179, 134, 71), new Color(50, 0, 0), 0.9d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Se Morenikoh", 7, new Color(179, 134, 71), new Color(50, 0, 0), 0.9d,
                          1.0d, 1.0d, false),
          new JugadorImpl("El Ruso", 8, new Color(179, 134, 71), new Color(233, 213, 54), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Paco Reyes Heredia", 9, new Color(179, 134, 71), new Color(50, 0, 0),
                          1.0d, 1.0d, 1.0d, false),
          new JugadorImpl("Richal", 10, new Color(179, 134, 71), new Color(50, 0, 0), 0.93d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Megamarc", 11, new Color(179, 134, 71), new Color(50, 0, 0), 0.93d, 1.0d,
                          1.0d, false)
      };
    }
  }
  ...
  public List<Command> execute(GameSituations sp) {
    ...
    if (newPosJugs == null) {
      newPosJugs = new Position[alineacion1.length];
    }
    comandos.clear();
    Position[] jugadores = sp.myPlayers();
    for (int i = 0; i < jugadores.length; ++i) {
      if (!posesionEnemiga(sp)) {
        newPosJugs[i] = alineacion3[i];
      } else {
        newPosJugs[i] = alineacion4[i];
      }
    }
...
//en la posicion de recuperacion
  ...
  private void pasa(int i, List<Command> comandos, GameSituations sp) {
    ...
    double
        fuerza =
        Math.min(1.0, dist(jugadores[i], jugadores[jugadorDestino]) / (Constants.ANCHO_CAMPO / 4));
