...
public class MSGTactica implements Tactic {
  ...
  public MSGTactica() {
    ...
    jugadores.add(new MSGPortero(
        ...
        "Juan Pablo",
        1,
        new MSGEstadisticas.Builder().setPrecision(0.5).setRemate(0.8).setVelocidad(1)
            .getMSGEstadisticas()));
    jugadores.add(new MSGDefensa(
        ...
        "Cote",
        2,
        new MSGEstadisticas.Builder().setPrecision(0.4).setRemate(0.4).setVelocidad(1)
            .getMSGEstadisticas()));
    jugadores.add(new MSGDefensa(
        2,
        Color.BLACK,
    ...
    jugadores.add(new MSGMedioCentro(
        ...
        "Lora",
        5,
        new MSGEstadisticas.Builder().setPrecision(1).setRemate(0.8).setVelocidad(1)
            .getMSGEstadisticas()));
    jugadores.add(new MSGMedioCentro(
        5,
        Color.BLACK,
  ...
  public List<Command> execute(GameSituations sp) {
    ...
    try {
      ...
      Map<Integer, MSGAlineacionPosicion>
          alineacion =
          MSGPosiciontHandlerManager.getPosicion(this, sp, null);
  ...
  public Position[] getStartPositions(GameSituations sp) {
    Map<Integer, MSGAlineacionPosicion>
        alineacion =
        MSGPosiciontHandlerManager.getPosicion(this, sp, Boolean.TRUE);
  ...
  public Position[] getNoStartPositions(GameSituations sp) {
    Map<Integer, MSGAlineacionPosicion>
        alineacion =
        MSGPosiciontHandlerManager.getPosicion(this, sp, Boolean.FALSE);
    return MSGUtils.convertPosicion(alineacion);
  }
