...
/**
 * <br>
 * Clase que representa una recta y=mx+b.
 * <br>
...
public class Recta {
    ...
    public Recta(Punto puntoA, Punto puntoB) {
        ...
        if (puntoB.getX() == puntoA.getX()) {
            ...
            this.b = (puntoA.getY() * puntoB.getX() - puntoB.getY() * puntoA.getX()) / (puntoB.getX() - puntoA.getX());
        }
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 19 * hash + (int) (Double.doubleToLongBits(this.m) ^ (Double.doubleToLongBits(this.m) >>> 32));
