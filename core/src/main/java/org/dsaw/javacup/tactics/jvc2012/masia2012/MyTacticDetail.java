  ...
  public PlayerDetail[] getPlayers() {
    return new PlayerDetail[]{
        new PlayerDetailImpl("Valdes", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                             0.85d, 1.0d, true),
        new PlayerDetailImpl("Pique", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.70d,
                             0.0d, false),
        new PlayerDetailImpl("Puyol", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.70d,
                             0.0d, false),
        new PlayerDetailImpl("Alba", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.70d,
                             0.0d, false),
        new PlayerDetailImpl("Montoya", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                             0.70d, 0.0d, false),
        new PlayerDetailImpl("Busquet", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                             1.0d, 0.95d, false),
        new PlayerDetailImpl("Xavi", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                             0.95d, false),
        new PlayerDetailImpl("Iniesta", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                             1.0d, 0.95d, false),
        new PlayerDetailImpl("Cuenca", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                             1.0d, false),
        new PlayerDetailImpl("Messi", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                             1.0d, false),
        new PlayerDetailImpl("Tello", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                             1.0d, false)
    };
  }
}
