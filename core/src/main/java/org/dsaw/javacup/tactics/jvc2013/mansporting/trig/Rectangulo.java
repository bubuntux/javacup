...
/**
 * <br> Clase que representa un rect�ngulo. <br> <br>Copyright Fi2net S.A. 10-ene-2011
 */
public class Rectangulo {
  ...
  public boolean equals(Object o) {
    ...
    if (Double.compare(that.alto, alto) != 0) {
      return false;
    }
    if (Double.compare(that.ancho, ancho) != 0) {
      return false;
    }
    if (!centro.equals(that.centro)) {
      return false;
    }
