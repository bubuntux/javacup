    ...
    public PlayerI[] getPlayers() {
      return new PlayerI[]{
          ...
          new JugadorImpl("Fabio", 11, new Color(246, 194, 148), new Color(50, 0, 0), 0.9d, 0.85d,
                          0.9d, false),
          new JugadorImpl("Damares", 12, new Color(116, 68, 24), new Color(50, 0, 0), 0.76d, 0.81d,
                          0.78d, false),
          new JugadorImpl("Paulo", 13, new Color(255, 200, 150), new Color(50, 0, 0), 0.9d, 0.65d,
                          0.71d, false),
          new JugadorImpl("Kaik", 14, new Color(255, 200, 150), new Color(33, 27, 27), 0.97d, 0.75d,
                          0.78d, false),
          new JugadorImpl("Igor", 15, new Color(255, 200, 150), new Color(50, 0, 0), 0.58d, 0.63d,
                          0.92d, false),
          new JugadorImpl("Nathan", 16, new Color(213, 146, 85), new Color(50, 0, 0), 0.69d, 0.73d,
                          1.0d, false),
          new JugadorImpl("Vitor", 17, new Color(255, 200, 150), new Color(0, 0, 0), 0.74d, 0.64d,
                          0.86d, false),
          new JugadorImpl("Raul", 18, new Color(201, 138, 82), new Color(50, 0, 0), 0.81d, 0.77d,
                          1.0d, false),
          new JugadorImpl("Otto", 19, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Adrian", 20, new Color(255, 200, 150), new Color(0, 0, 0), 1.0d, 1.0d,
                          1.0d, false)
      };
    }
  }
