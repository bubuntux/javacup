...
public class TacticaPulgarcitos implements Tactic {
  ...
  class TacticaDetalleImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Libman", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          true),
          new JugadorImpl("Carmona", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Ramos", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Ibañez", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Villamarin", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1d,
                          0.625d, 0.5d, false),
          new JugadorImpl("Gonzales", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Jayo", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Hurtado", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                          0.5d, false),
          new JugadorImpl("Fernandez", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false),
          new JugadorImpl("Montaño", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false),
          new JugadorImpl("Bazan", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                          false)
      };
    }
  }
  ...
  private boolean attacking() {
    ...
    return sp.isStarts() || (!sp.isRivalStarts() && iterToBall >= 0 && (opponentIterToBall < 0
                                                                        || iterToBall
                                                                           < opponentIterToBall));
  }
  ...
  public List<Command> execute(GameSituations sp) {
    ...
    // es córner
    if (sp.isStarts() && (sp.ballPosition() == Constants.cornerSupDer
                          || sp.ballPosition() == Constants.cornerSupDer)) {
