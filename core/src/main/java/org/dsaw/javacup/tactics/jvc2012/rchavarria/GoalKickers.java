...
public class GoalKickers {
  ...
  /**
   * @param i numero de jugador
   * @return true si se trata de un jugador para rematar a puerta
   */
  ...
  /**
   * @param sp     contexto del juego
   * @param player jugador al cual asignar el comando
   * @return un comando de remate a puerta o un comando de avance
   */
   ...
   *
   * @return comando de remate a puerta
   */
