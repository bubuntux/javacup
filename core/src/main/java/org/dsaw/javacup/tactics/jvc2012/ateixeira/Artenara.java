...
public class Artenara implements Tactic {
  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("H", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.56d, 1.0d,
                          true),
          new JugadorImpl("He", 2, new Color(255, 200, 150), new Color(50, 0, 0), 0.83d, 0.5d,
                          0.71d, false),
          new JugadorImpl("Li", 3, new Color(255, 200, 150), new Color(50, 0, 0), 0.85d, 0.5d,
                          0.75d, false),
          new JugadorImpl("Be", 4, new Color(255, 200, 150), new Color(50, 0, 0), 0.92d, 0.67d,
                          0.81d, false),
          new JugadorImpl("B", 5, new Color(255, 200, 150), new Color(50, 0, 0), 0.92d, 0.66d,
                          0.58d, false),
          new JugadorImpl("C", 6, new Color(255, 200, 150), new Color(50, 0, 0), 0.72d, 0.66d,
                          0.61d, false),
          new JugadorImpl("N", 7, new Color(255, 200, 150), new Color(50, 0, 0), 0.81d, 0.69d,
                          0.55d, false),
          new JugadorImpl("O", 8, new Color(255, 200, 150), new Color(50, 0, 0), 0.98d, 0.77d,
                          0.67d, false),
          new JugadorImpl("F", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.91d, 0.86d,
                          false),
          new JugadorImpl("Ne", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.94d,
                          0.82d, false),
          new JugadorImpl("Na", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.92d,
                          0.89d, false)
      };
    }
  }
      ...
      if (recuperadores.length > 1) {
        ...
        for (int i = 1; i < recuperadores.length; i++) { //Solo 2 van a recuperar
          ...
          if (recuperadores[i] != 0) {
            ...
            comandos.add(
                new CommandMoveTo(recuperadores[i], new Position(posRecuperacion[0], Profundidad)));
            Position Jugadores[] = new Position[3];
  ...
  private Position TiroAPuerta(Position PosDelantero, Position PosPortero) {
    ...
    b =
        (2 * PosDelantero.getX() * PosDelantero.getY() - PosDelantero.getX() * PosPortero.getY()
         + PosDelantero.getY() * PosDelantero.getX()) / (PosPortero.getX() * PosPortero.getX());
   ...
   */
  private Position DecidirPase(Position Jugadores[], Position JugadoresFuturo[],
                               GameSituations sp) {
