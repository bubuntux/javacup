    ...
    public List<Command> execute(GameSituations sp) {
        ...
        if( sp.ballPosition().getX() < -9 ) {
            comandos.add( new CommandMoveTo(0,
                    new Position( alineacion1[0].getX()-2, alineacion1[0].getY()) ) );
        ...
        for(int i=1; i<jogadores.length; i++ ){
            ...
            if( dist > 50.0 ){
                comandos.add( new CommandMoveTo(i,
                    new Position(
                    alineacion1[i].getX()+(sp.ballPosition().getX() - jogadores[i].getX())*0.3 ,
                    alineacion1[i].getY()+(sp.ballPosition().getY() - jogadores[i].getY())*0.3) )
                );
            }
            else if( dist>30 ) {
                comandos.add( new CommandMoveTo(i,
                    new Position(
                    alineacion1[i].getX()+(sp.ballPosition().getX() - jogadores[i].getX())*0.5 ,
                    alineacion1[i].getY()+(sp.ballPosition().getY() - jogadores[i].getY())*0.5) )
                );
                ...
                comandos.add( new CommandMoveTo(i,
                    new Position(
                    alineacion1[i].getX()+(sp.ballPosition().getX() - jogadores[i].getX())*0.8 ,
                    alineacion1[i].getY()+(sp.ballPosition().getY() - jogadores[i].getY())*0.8) )
                );
            }
        }
        ...
        for (int i : sp.canKick()) {
            if( i==0 ){
                ...
                if( NossoUtil.possoChutar(jogadores[i]) )
                    comandos.add( NossoUtil.chutarGol( i, meusDetalhes[i].getPrecision(), meusDetalhes[i].getSpeed(), jogadores[i], rivais ));
                else {
