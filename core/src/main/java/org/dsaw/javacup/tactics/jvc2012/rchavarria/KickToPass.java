...
public class KickToPass {
  ...
  /**
   * @return true si se decide que se va a pasar a un compa�ero o no basado en probabilidades
   */
  ...
  /**
   * @param kickerPlayer jugador que tiene el balon y pasara
   * @param targetPlayer posible jugador que recibir� el pase
   * @param players      datos sobre los jugadores
   * @return true si targetPlayer es un buen candidato para pasarle el bal�n
   */
