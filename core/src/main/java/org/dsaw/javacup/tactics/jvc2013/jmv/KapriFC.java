    ...
    public PlayerI[] getPlayers() {
      return new PlayerI[]{
          ...
          new JugadorImpl("Puyol", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.78d,
                          0.75d, false),
          new JugadorImpl("Sergio Ramos", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                          0.79d, 0.79d, false),
          new JugadorImpl("Pique", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.77d,
                          0.76d, false),
          new JugadorImpl("Busquets", 5, new Color(255, 200, 150), new Color(50, 0, 0), 0.83d,
                          0.71d, 0.72d, false),
          new JugadorImpl("Iniesta", 6, new Color(255, 200, 150), new Color(50, 0, 0), 0.79d, 0.78d,
                          0.67d, false),
          new JugadorImpl("Di Maria", 7, new Color(255, 200, 150), new Color(50, 0, 0), 0.76d,
                          0.64d, 0.57d, false),
          new JugadorImpl("Xavi", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          0.5d, false),
          new JugadorImpl("Cristiano Ronaldo", 9, new Color(255, 200, 150), new Color(50, 0, 0),
                          1.0d, 0.75d, 0.65d, false),
          new JugadorImpl("Mesi", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Villa", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false)
      };
    }
  }
...
//					//System.out.println("SACO. iteracionesParaSacar: " + iteracionesParaSacar);
          ...
          if (iteracionesParaSacar == Constants.ITERACIONES_SAQUE - 10) {
            ...
            while ((j = r.nextInt(jugadores.length)) == jugador
                   && jugadores[jugador].getY() > jugadores[j].getY() && count < 20) {
              count++;
            }
            ;
