...
public class InfoTrayectoria implements Comparable<InfoTrayectoria> {
  ...
  public InfoTrayectoria(final double fuerza, final double potencia, final double angulo,
                         final double distancia, final int iteraciones,
                         final TreeSet<Double> distancias) {
    super();
    this.fuerza = fuerza;
  ...
  public InfoTrayectoria(final InfoTrayectoria info) {
    this(info.getFuerza(), info.getPotencia(), info.getAngulo(), info.getDistancia(),
         info.getIteraciones(), info.getDistancias());
  }
  ...
  public String toString() {
    return "F: " + TacticaRomedalusTeam.round(fuerza, 2) + "\tP: " + TacticaRomedalusTeam
        .round(potencia, 2) + "\tAng: " + TacticaRomedalusTeam
               .round(angulo * TacticaRomedalusTeam.TO_ANG, 2) + "\tDist:" + distancia + "\tIter: "
           + iteraciones
           + "\n";
  }
}
