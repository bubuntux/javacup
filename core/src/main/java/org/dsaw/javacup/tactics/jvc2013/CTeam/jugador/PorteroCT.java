...
public class PorteroCT extends AbstractJugador {
  ...
  public PorteroCT(Equipo equipo, int indice, PlayerI detalle, ICTeam2011 tactica) {
  ...
  public Collection<? extends Command> jugar() {
    ...
    if (Math.abs(dif) <= 0.125) {
      ...
      comandos
          .add(new CommandMoveTo(getIndice(), new Position(x, Constants.centroArcoInf.getY() + 2)));
    }
