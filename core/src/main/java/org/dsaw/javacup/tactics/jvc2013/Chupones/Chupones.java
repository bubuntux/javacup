...
package org.dsaw.javacup.tactics.jvc2013.Chupones;
...
public class Chupones implements Tactic {
  ...
  class TacticaDetalleImpl implements Team {
    ...
    public PlayerI[] getPlayers() {
      return new PlayerI[]{
          new JugadorImpl("Singuli", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, true),
          new JugadorImpl("Bini", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Terni", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Quaterni", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Quini", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Seni", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Septeni", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Octoni", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Noveni", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Deni", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false),
          new JugadorImpl("Undeni", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          1.0d, false)
      };
    }
  }
  ...
  /**
   * Matriz de distancias al cuadrado entre dos conjuntos de posiciones (de jugadores y de
   * rivalPlayers) dist2[j1][j2] es la distancia al cuadrado entre jugador j1 y rival j2
   */
  private double[][] dist2 = new double[N][N];

  /**
   * Mejores emparejamientos entre jugadores y rivalPlayers. mejorPareja[0][j2] es el mejor jugador
   * dado rival j2 mejorPareja[1][j1] es el mejor rival dado jugador j1
   */
  ...
  /**
   * Posiciones relativas polares entre jugadores, rivalPlayers, y bal�n. posRelJugs[0][j][j1] es la
  ...
  /**
   * Calcula matriz dist2, de distancias al cuadrado entre jugadores (aj1) y rivalPlayers (aj2).
   *
  ...
  /**
   * Calcula los mejores emparejamientos entre jugadores y rivalPlayers, es decir, el conjunto de
   * mapeos (jugador, rival) que garantiza el menor tiempo para desplazarse los jugadores hasta sus
   * rivalPlayers, dadas sus posiciones, en conjunto. El resultado est� indexado por jugador
   * propio.
   *
   * @param aj1 Array de posiciones de jugadores.
  ...
  /**
   * Calcula la mejor posici�n destino de los jugadores dada la posici�n del bal�n y la de los
   * rivalPlayers. Considera la mejor posici�n como la de cada rival pero algo desplazada en
   * direcci�n al bal�n. El resultado est� indexado por jugador rival.
   *
   * @param balon Posici�n del bal�n.
   * @param aj2   Array de posiciones de rivalPlayers.
   ...
   * disparo hacia la porter�a rival. Ignora posiciones en el campo propio. ampDisparo es el �ngulo
   * m�ximo entre postes no controlado por el portero, (ignorando otros rivalPlayers) y dirDisparo
   * es la direcci�n central en ese �ngulo.
   *
  ...
  /**
   * Calcula mejor posici�n para el portero. Considera la posici�n del bal�n como origen del
   * peligro, y decide la posici�n del portero minimizando el/los �ngulos de porter�a no cubiertos
   * por �l.
   *
   * @param sp Situaci�n del partido.
  ...
  /**
   * Devuelve el n�mero aproximado de iteraciones hasta que el bal�n llegue a una altura, en la
   * parte descendente de la par�bola.
   *
  ...
  /**
   * Muestra una matriz de mejores posiciones de pase, para depurar m�todo mejoresPosicionesPase.
   *
  ...
  /**
   * Devuelve un array con las mejores posiciones de pase a cada jugador. Usa el m�todo del simplex,
   * considerando, para cada jugador, el politopo que lo contiene y est� limitado con caras con
   * pendiente 1 que pasan por las mediatrices del jugador y cada uno de sus rivalPlayers. Hay 4
   * caras adicionales, que pasan por las bandas. WARNING: No ha sido suficientemente testeado.
   *
   * @param aj1 Situaci�n del partido
