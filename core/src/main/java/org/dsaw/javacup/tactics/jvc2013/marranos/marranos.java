    ...
    class TacticaDetalleImpl implements TacticDetail {
        ...
        public PlayerDetail[] getPlayers() {
            return new PlayerDetail[]{
                new JugadorImpl("Jugador", 1, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, true),
                new JugadorImpl("Jugador", 2, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 3, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 4, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 5, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 6, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 7, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 8, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 9, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 10, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false),
                new JugadorImpl("Jugador", 11, new Color(255,200,150), new Color(50,0,0),0.5d,0.5d,0.5d, false)
            };
        }
    }
