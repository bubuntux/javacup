...
public class GoalKeeper extends BasicCommandGenerator {
  ...
  /**
   * Devuelve la lista de commandos del portero en función de la situación del partido
   *
  ...
  /**
   * Devuelve la mejor posición del portero respecto al balón. Es el resultado de hallar la
   * intersección entre la línea de portero (paralela a la línea de meta) y la bisectriz formada por
   * las rectas A y B, siendo A la recta entre el balón y el poste izquierdo y B la recta entre el
   * balón y el poste derecho.
   *
