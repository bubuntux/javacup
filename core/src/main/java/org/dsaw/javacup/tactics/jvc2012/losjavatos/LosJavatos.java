  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Jorge", 1, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, true),
          new JugadorImpl("Javi", 2, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          0.35d, 0.35d, false),
          new JugadorImpl("Alex", 3, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d, 0.5d,
                          0.5d, false),
          new JugadorImpl("Juan Carlos", 4, new Color(255, 200, 150), new Color(255, 255, 255),
                          1.0d, 0.3d, 0.5d, false),
          new JugadorImpl("Jesús", 5, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          0.5d, 0.5d, false),
          new JugadorImpl("Roberto", 6, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          0.5d, 0.5d, false),
          new JugadorImpl("Angel", 7, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Miguel", 8, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Fran", 9, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Juan H", 10, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false),
          new JugadorImpl("Leon", 11, new Color(255, 200, 150), new Color(255, 255, 255), 1.0d,
                          1.0d, 1.0d, false)
      };
    }
  }
