...
public class LineUps {
  ...
  /**
   * Si 'y' es positiva, esta en la parte izqda. Si 'y' es mayor que un tercio de la mitad positiva
   * del ancho, estamos en el tercio superior
   *
   * campo de juego ���=========================+ centro del campo (y = 0)
   ...
   * del ancho, estamos en el tercio superior
   *
   * campo de juego ���-------------------------+ parte superior (y = Constants.ANCHO_CAMPO_JUEGO /
   * 2) | ���-------------------------+ tercio inferor (Constants.ANCHO_CAMPO_JUEGO / 2 / 3)
