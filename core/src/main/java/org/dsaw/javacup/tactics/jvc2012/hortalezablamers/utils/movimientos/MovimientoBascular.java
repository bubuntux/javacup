...
public class MovimientoBascular {
  ...
  /**
   * Esta funcion calcula la posicion que deber� ocupar el jugador en el campo, en funcion de un
   * punto sobre el que pivota, y un rectangulo de maximo alcance
   *
  ...
  /**
   * Esta funcion calcula la posicion que deber� ocupar el portero en el campo. Se situa siempre
   * tratando de cubrir la mayor cantidad de porteria posible
   */
