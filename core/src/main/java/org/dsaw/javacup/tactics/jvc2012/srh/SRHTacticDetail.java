...
public class SRHTacticDetail implements TacticDetail {
  ...
  public PlayerDetail[] getPlayers() {
    return new PlayerDetail[]{
        new JugadorImpl("Vanesa", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                        true),
        new JugadorImpl("Ximo", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d, 0.5d,
                        false),
        new JugadorImpl("Javi", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d, 0.5d,
                        false),
        new JugadorImpl("Victor", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                        0.5d, false),
        new JugadorImpl("Jose", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d, 0.5d,
                        false),
        new JugadorImpl("Juan", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d, 0.5d,
                        false),
        new JugadorImpl("Cerdá", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d, 0.5d,
                        false),
        new JugadorImpl("Corbin", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 0.625d,
                        0.5d, false),
        new JugadorImpl("Ripoll", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                        false),
        new JugadorImpl("Colomer", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1d, 1d, 1d,
                        false),
