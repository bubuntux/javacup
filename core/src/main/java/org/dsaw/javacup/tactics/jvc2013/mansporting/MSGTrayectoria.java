...
public abstract class MSGTrayectoria<E extends MSGPuntoTrayectoria> {
    ...
    public static class SituacionPartidoTrayectoria extends MSGTrayectoria<MSGPuntoTrayectoria.Punto3DTrayectoria> {
    ...
    public static class DisparoTrayectoria extends MSGTrayectoria<MSGPuntoTrayectoria.Punto3DErrorTrayectoria> {
