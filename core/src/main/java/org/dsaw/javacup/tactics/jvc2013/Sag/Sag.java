    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          ...
          new JugadorImpl("Berto", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          0.75d, false),
          new JugadorImpl("Paudavy", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          0.75d, false),
          new JugadorImpl("Jorge", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.54d,
                          0.74d, false),
          new JugadorImpl("Raul", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.53d,
                          0.76d, false),
          new JugadorImpl("Richi", 6, new Color(255, 200, 150), new Color(50, 0, 0), 0.99d, 0.59d,
                          0.8d, false),
          new JugadorImpl("Martin", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.73d,
                          0.75d, false),
          new JugadorImpl("Jose", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.65d,
                          0.75d, false),
          new JugadorImpl("Patxi", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.92d,
                          0.95d, false),
          new JugadorImpl("Chema", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false),
          new JugadorImpl("Monty", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, false)
      };
    }
  }
    ...
    if (rc.length > 0) {
      ...
      for (int i = 1; i < tBalon; i++) {
        ...
        if (puntoIc[0] != puntoRecuperacion[0]
          ...
          jugadores[recuperadoresSag[0]]
              .evaluarIntercepcion(posRc, jugadores[recuperadoresSag[1]], i);
        }
