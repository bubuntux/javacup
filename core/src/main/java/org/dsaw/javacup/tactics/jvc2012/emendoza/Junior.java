package org.dsaw.javacup.tactics.jvc2012.emendoza;
  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      return new PlayerDetail[]{
          new JugadorImpl("Adrián Berbia", 1, new Color(255, 200, 150), new Color(50, 0, 0), 0.6d,
                          0.5d, 0.5d, true),
          new JugadorImpl("Camilo Andrés Ceballos Zapata", 2, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Roller Cambindo Ibarra", 3, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("César Augusto Fawcett Lebolo", 4, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("César Augusto Fawcett Lebolo", 5, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Jáider José Romero Romero", 6, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("John Alexánder Jaramillo Gómez", 7, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Giovanni Hernández Soto", 8, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Vladimir Javier Hernández", 9, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Carlos Arturo Bacca Ahumada", 10, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.5d, 0.5d, 0.5d, false),
          new JugadorImpl("Teófilo Antonio Gutiérrez", 11, new Color(255, 200, 150),
                          new Color(50, 0, 0), 0.8d, 0.8d, 0.4d, false)
      };
    }
  }
