  ...
  class TacticDetailImpl implements TacticDetail {
    ...
    public PlayerDetail[] getPlayers() {
      ...
      return new PlayerDetail[]{
          new JugadorImpl("Mole", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d,
                          1.0d, true),
          new JugadorImpl("Periketa", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Periketo", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Perikin", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Perikina", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Periko", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Perika", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Peri", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.7d,
                          0.8d, false),
          new JugadorImpl("Perikero", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          0.8d, false),
          new JugadorImpl("Perikera", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.5d,
                          0.8d, false),
          new JugadorImpl("Perikerin", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d,
                          0.5d, 0.9d, false)
      };
            /*Full error*/
//            return new PlayerDetail[]{
