...
public class RealVencedoresJuego implements Tactic {
  ...
  /**
   * @param rivalesCubiertos Lista de rivales cubiertos por mis jugadores
   * @param rival            Rival a evaluar
   ...
   *
   * @param miJugador Posición de mi jugador
   * @param rival     Posición del jugador rival
