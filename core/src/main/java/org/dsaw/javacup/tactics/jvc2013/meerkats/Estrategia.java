...
public class Estrategia implements Tactic {
     ...
     */
    private LinkedList<Integer> jugadoresMarcados = new LinkedList<Integer>();    
	...
	controladorjugador.update(sp, spItAnterior, comandos, cuartoCancha, jugadoresMarcados, atacando);
	...
	controladorjugador.comportamientoArquero();
        if (sp.isStarts()) {
	    comandos = new LinkedList<Command>(comandos.subList(0, Utilitarios.NUMERO_JUGADORES));
