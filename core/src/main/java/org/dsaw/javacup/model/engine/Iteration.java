...
final class Iteration implements Serializable {
  ...
  public Iteration(boolean gol, boolean poste, boolean rebotando, boolean ovacionando,
                   boolean rematando, boolean sacando,
                   boolean silbando, boolean cambioSaque, boolean offSide,
                   boolean libreIndirecto, double alturaBalon, Position posVisibleBalon,
                   Position[][] posiciones,
