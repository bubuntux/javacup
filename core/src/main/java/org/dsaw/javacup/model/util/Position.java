...
/**
 * Class representing horizontal spatial coordinates Clase que representa las coordenadas espaciales
 * horizontales
 */
public final class Position implements Serializable {
  ...
  /**
   * Obtiene un arreglo ordenado de los indices mas cercanos a los mas lejanos, excluyendo una
   * lista
   */
  ...
  /**
   * Define una norma para comparar distancias, es mas rapido el calculo que usar el metodos
   * distancia
   */
  public double norm() {
    return x * x + y * y;
