package org.dsaw.javacup.model.command;
...
public final class CommandHitBall extends Command {
  ...
  /**
   * Instance a CommandHitBall Object to set the player index, the destiny coordenate, the power
   * (0-1) and if is high kick (High kick have a vertical angle=Constants.ANGULO_VERTICAL)
   */
  ...
  /**
   * Instance a CommandHitBall Object to set the player index, the destiny coordenate, the power
   * (0-1) and the vertical angle (0-Constants.ANGULO_VERTICAL_MAX)
   */
