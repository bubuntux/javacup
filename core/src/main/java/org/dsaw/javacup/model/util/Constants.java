...
public class Constants {
  ...
  /**
   * Altura maxima en que  los jugadores pueden controlar el balon, solo el portero puede controlar
   * hasta ALTO_ARCO
   */
  ...
  //#######################################################
  /**
   * Parametro para configurar como la camara sigue la posicion del balon, mientra mayor sea mas
   * suave seran los movimientos de la camara
   */
  ...
  public static final Position
      esqSupIzqCircCentral =
      new Position(-Constants.RADIO_CIRCULO_CENTRAL, -Constants.RADIO_CIRCULO_CENTRAL);
  /**
   * Esquina superior izquierda del campo (zona de pasto)
   */
  public static final Position
      esqSupIzqCampo =
      new Position(-Constants.ANCHO_CAMPO / 2.0, -Constants.LARGO_CAMPO / 2.0);
  /**
   * Dimensiones del campo (zona de pasto)
   */
  public static final Position
      dimCampo =
      new Position(Constants.ANCHO_CAMPO, Constants.LARGO_CAMPO);
  /**
   * Esquina superior izquierda del campo de juego
   */
  public static final Position
      esqSupIzqCampoJuego =
      new Position(-Constants.ANCHO_CAMPO_JUEGO / 2.0, -Constants.LARGO_CAMPO_JUEGO / 2.0);
  /**
   * Dimensiones del campo de juego
   */
  public static final Position
      dimCampoJuego =
      new Position(Constants.ANCHO_CAMPO_JUEGO, Constants.LARGO_CAMPO_JUEGO);
  /**
   * Esquina superior izquierda del area grande superior
   */
  public static final Position
      esqSupIzqAreaGrandeSup =
      new Position(-Constants.LARGO_AREA_GRANDE / 2, -Constants.LARGO_CAMPO_JUEGO / 2);
  /**
   * Esquina superior izquierda del area grande inferior
   */
  public static final Position
      esqSupIzqAreaGrandeInf =
      new Position(-Constants.LARGO_AREA_GRANDE / 2,
  ...
  public static final Position
      dimAreaGrande =
      new Position(Constants.LARGO_AREA_GRANDE, Constants.ANCHO_AREA_GRANDE);
  /**
   * Esquina superior izquierda del area chica superior
   */
  public static final Position
      esqSupIzqAreaChicaSup =
      new Position(-Constants.LARGO_AREA_CHICA / 2, -Constants.LARGO_CAMPO_JUEGO / 2);
  /**
   * Esquina superior izquierda del area chica inferior
   */
  public static final Position
      esqSupIzqAreaChicaInf =
      new Position(-Constants.LARGO_AREA_CHICA / 2,
  ...
  public static final Position
      dimAreaChica =
      new Position(Constants.LARGO_AREA_CHICA, Constants.ANCHO_AREA_CHICA);
  /**
   * Position del punto penal superior
   */
  public static final Position
      penalInf =
      new Position(0, -Constants.LARGO_CAMPO_JUEGO / 2 + Constants.DISTANCIA_PENAL);
  /**
  ...
  public static final Position
      esqSupIzqPenalSup =
      new Position(-Constants.RADIO_PENAL,
                   -Constants.LARGO_CAMPO_JUEGO / 2 + Constants.DISTANCIA_PENAL
                   - Constants.RADIO_PENAL);
  /**
  ...
  public static final Position
      posteIzqArcoInf =
      new Position(-Constants.LARGO_ARCO / 2, -Constants.LARGO_CAMPO_JUEGO / 2);
  /**
  ...
  public static final Position
      cornerInfDer =
      esqSupIzqCampoJuego.movePosition(Constants.ANCHO_CAMPO_JUEGO, 0);
  /**
   * Corner inferior izquierdo
   */
  public static final Position
      cornerSupIzq =
      esqSupIzqCampoJuego.movePosition(0, Constants.LARGO_CAMPO_JUEGO);
  /**
   * Corner inferior derecho
   */
  public static final Position
      cornerSupDer =
      cornerSupIzq.movePosition(Constants.ANCHO_CAMPO_JUEGO, 0);
  //################################################################################
  /**
