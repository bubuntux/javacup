package org.dsaw.javacup.model.trajectory;

/**
 * Clase que al extenderla permite definir trayectorias por tramos. Luego de manera recursiva se
 * obtiene el valor de la trayectoria en cualquier instante de tiempo futuro.
 */
