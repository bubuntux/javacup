...
package org.javahispano.javacup.tacticas.jvc2012.petardos;
...
public class Petardos implements Tactic {
	...
	class TacticDetailImpl implements TacticDetail {
		...
		public PlayerDetail[] getPlayers() {
			return new PlayerDetail[]{
				new JugadorImpl("Petardo01",  1, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, true),
				new JugadorImpl("Petardo02",  2, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo03",  3, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo04",  4, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo05",  5, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo06",  6, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo07",  7, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo08",  8, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo09",  9, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo10", 10, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false),
				new JugadorImpl("Petardo11", 11, new Color(255,200,150), new Color(50,0,0),1.0d,0.5d,1.0d, false)
			};
		}
	}
	 ...
	 * entre dos conjuntos de posiciones (de jugadores y de rivales)
	 * dist2[j1][j2] es la distancia al cuadrado entre jugador j1 y rival j2
	 */
	private double[][] dist2 = new double[N][N];

	/**
	 * Mejores emparejamientos entre jugadores y rivales.
	...
	/**
	 * Posiciones relativas polares entre jugadores, rivales, y balón.
	 ...
	 * entre jugadores (aj1) y rivales (aj2).
	...
	/**
	 * Calcula los mejores emparejamientos entre jugadores y rivales,
	 * es decir, el conjunto de mapeos (jugador, rival) que garantiza
	 * el menor tiempo para desplazarse los jugadores hasta sus rivales,
	 * dadas sus posiciones, en conjunto.
	 * El resultado está indexado por jugador propio.
	 * @param aj1   Array de posiciones de jugadores.
	...
	/**
	 * Calcula la mejor posición destino de los jugadores
	 * dada la posición del balón y la de los rivales.
	 * Considera la mejor posición como la de cada rival pero
	 * algo desplazada en dirección al balón.
	 * El resultado está indexado por jugador rival.
	 ...
	 * hacia la portería rival. Ignora posiciones en el campo propio.
	 * ampDisparo es el ángulo máximo entre postes no controlado por el portero,
	 * (ignorando otros rivales) y dirDisparo es la dirección central en ese ángulo.
	...
	/**
	 * Calcula mejor posición para el portero.
	 * Considera la posición del balón como origen del peligro,
	 * y decide la posición del portero minimizando 
	 * el/los ángulos de portería no cubiertos por él.
	 * @param sp    Situación del partido.
	...
	/**
	 * Devuelve el número aproximado de iteraciones hasta que el balón 
	 * llegue a una altura, en la parte descendente de la parábola.
	 ...
	 * para depurar mótodo mejoresPosicionesPase.
	 ...
	 * Usa el método del simplex, considerando, para cada jugador, el politopo
	 * que lo contiene y está limitado con caras con pendiente 1 que pasan por
	 * las mediatrices del jugador y cada uno de sus rivales. Hay 4 caras
