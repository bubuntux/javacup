package org.javahispano.javacup.tacticas.jvc2012.team2012;
...
//								}
			...
			Position posArquero = Helper.getPosicionArquero(sp.ballPosition(),
					pRivalMasCercano, pMiArquero, sp.ballAltitude(),
					balonPasado);
	...
	private CommandHitBall mejorDisparoAlArco(final int idxPateador,
			final double minAngZ, final double maxAngZ, final GameSituations sp) {
		int idxPortRival = 0;
