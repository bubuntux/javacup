 ...
 */
public final class Transformer { //TODO ???

  /**
   * Obtiene las ubicacion en pixeles, de una posicion real relativa de otra con una escala de
   * pixeles por unidad
   */
  public static int[] transform(Position pos, Position posRel, int xPixel, int yPixel,
                                double escala) {
