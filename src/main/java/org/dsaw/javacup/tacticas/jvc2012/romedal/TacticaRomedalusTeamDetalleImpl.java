package org.dsaw.javacup.tacticas.jvc2012.romedal;
...
public class TacticaRomedalusTeamDetalleImpl implements TacticDetail {
	...
	public PlayerDetail[] getPlayers() {
		...
		// new JugadorImpl("Adriano", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d, 1.0d, false) };//
				...
				new JugadorImpl("Valdes", 1, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.75d, 1.0d, true),//
				new JugadorImpl("Pique", 2, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Puyol", 3, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Muniesa", 4, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Montoya", 5, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Busquet", 6, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Xavi", 7, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Iniesta", 8, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.35d, 1.0d, false),//
				new JugadorImpl("Bojan", 9, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.65d, 1.0d, false),//
				new JugadorImpl("Messi", 10, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 1.0d, 1.0d, false),//
				new JugadorImpl("Pedro", 11, new Color(255, 200, 150), new Color(50, 0, 0), 1.0d, 0.65d, 1.0d, false) };//
